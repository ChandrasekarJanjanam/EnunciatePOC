...
public interface ClaimService {
  ...
  java.util.List<com.ibm.openinsurance.domain.BodyShop> getBodyShops(@javax.jws.WebParam( name = "policyId", targetNamespace="", mode = javax.jws.WebParam.Mode.IN , header = false, partName = "policyId" ) java.lang.String policyId, @javax.jws.WebParam( name = "userId", targetNamespace="", mode = javax.jws.WebParam.Mode.IN , header = false, partName = "userId" ) java.lang.String userId, @javax.jws.WebParam( name = "location", targetNamespace="", mode = javax.jws.WebParam.Mode.IN , header = false, partName = "location" ) java.lang.String location) ;
  ...
  com.ibm.openinsurance.domain.Claim getClaimDetails(@javax.jws.WebParam( name = "policyId", targetNamespace="", mode = javax.jws.WebParam.Mode.IN , header = false, partName = "policyId" ) java.lang.String policyId, @javax.jws.WebParam( name = "userId", targetNamespace="", mode = javax.jws.WebParam.Mode.IN , header = false, partName = "userId" ) java.lang.String userId) ;
