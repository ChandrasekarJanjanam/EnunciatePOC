...
{   
     ...
     */
    @Path("/insurance/policies/{policyID}/roadsideassistance")
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Claim getAssistanceDetails(@PathParam("policyID") String policyId, @QueryParam("UserID") String userId);
